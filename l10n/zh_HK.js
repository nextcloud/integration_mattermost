OC.L10N.register(
    ...
    "%s in @%s at %s" : "用戶 %s 頻道 @%s 創建於 %s",
    "%s in #%s at %s" : "用戶 %s 頻道 #%s創建於 %s",
    ...
    "Mattermost integration provides a dashboard widget displaying your most important notifications\nand a unified search provider for messages. It also lets you send files to Mattermost from Nextcloud Files." : "Mattermost 整合提供了一個儀表板小部件，顯示您最重要的通知以及統一的消息搜索提供程序。其也讓您您將檔案從 Nextcloud Files 發送到 Mattermost。",
    "Mattermost admin options saved" : "已儲存 Mattermost 管理員選項",
    "Failed to save Mattermost admin options" : "儲存 Mattermost 管理員選項失敗",
    "If you want to allow your Nextcloud users to use OAuth to authenticate to a Mattermost instance of your choice, create an application in your Mattermost settings and set the ID and secret here." : "如果您想要讓您的 Nextcloud 用戶使用 OAuth 來驗證您選擇的 Mattermost 站台的話，在您的 Mattermost 設定中建立應用程式，然後在此處設定 ID 與密碼。",
    "Make sure you set the \"Redirect URI\" to" : "確保您將「重新導向 URI」設定為",
    "Put the \"Application ID\" and \"Application secret\" below. Your Nextcloud users will then see a \"Connect to Mattermost\" button in their personal settings if they select the Mattermost instance defined here." : "在下方填入「應用程式 ID」與「應用程式密碼」。如果您的 Nextcloud 用戶選擇了在此定義的 Mattermost 站台，他們將會在個人設定中看到【連線至 Mattermost 】按鈕。",
    ...
    "Application secret of your Mattermost application" : "您 Mattermost 應用程式的應用程式密碼",
    ...
    "Error connecting to Mattermost:" : "連線至 Mattermost 時發生錯誤：",
    ...
    "Mattermost personal access token" : "Mattermost 個人存取權杖",
    "Login" : "登入",
    "Mattermost login" : "Mattermost 登入",
    "Password" : "密碼",
    "Mattermost password" : "Mattermost 密碼",
    "Connect to Mattermost" : "連線至 Mattermost ",
    "Connected as {user}" : "以 {user} 身份連線",
    "Disconnect from Mattermost" : "與 Mattermost 斷開連線",
    "Add file action to send files to Mattermost" : "新增檔案操作以傳送檔案至 Mattermost",
    "Enable navigation link (link to Mattermost with a top menu item)" : "啟用導航連結（透過頂部選單項目連結至 Mattermost）",
    "Enable searching for messages" : "啟用訊息搜尋",
    "Warning, everything you type in the search bar will be sent to Mattermost." : "警告，您在搜尋欄中輸入的所有內容都會傳送給 Mattermost。",
    ...
    "View only" : "僅檢視",
    "Edit" : "編輯",
    "Failed to load Mattermost channels" : "載入 Mattermost 頻道失敗",
    ...
    "Cancel" : "取消",
    "_Send file to Mattermost_::_Send files to Mattermost_" : ["傳送檔案至 Mattermost"],
    "_Send link to Mattermost_::_Send links to Mattermost_" : ["傳送連結至 Mattermost"],
    "_Send file_::_Send files_" : ["傳送檔案"],
    "_Send link_::_Send links_" : ["傳送連結"],
    "No Mattermost account connected" : "未連線至 Mattermost 帳戶",
    "Error connecting to Mattermost" : "連線至 Mattermost 時發生錯誤",
    "No Mattermost notifications!" : "無 Mattermost 通知！",
    "Failed to get Mattermost notifications" : "未能獲取 Mattermost 通知",
    ...
    "You need to connect before using the Mattermost integration." : "在使用 Mattermost 整合前，您必須連接至 Mattermost 應用程式。",
    "Do you want to connect to {mmUrl}?" : "您要連線到 {mmUrl} 嗎?",
    "You can choose another Mattermost server in the {settingsHtmlLink} section of your personal settings." : "您可以在個人設定的 {settingsHtmlLink} 部分中選擇另一個 Mattermost 伺服器。",
    "Connect" : "連線",
    "You need to connect to a Mattermost server before using the Mattermost integration." : "在使用 Mattermost 整合前，您必須連線至 Mattermost 伺服器。",
