OC.L10N.register(
    ...
    "If you want to allow your Nextcloud users to use OAuth to authenticate to a Mattermost instance of your choice, create an application in your Mattermost settings and set the ID and secret here." : "Nextcloud kullanıcılarınızın seçeeceğiniz Mattermost kopyası kimlik doğrulaması için OAuth uygulamasını kullanmak istiyorsanız, Mattermost ayarlarınızdan bir uygulama oluşturun ve aşağıya kimlik ve parola bilgilerini yazın.",
    ...
    "You need to connect before using the Mattermost integration." : "Mattermost bütünleştirmesini kullanmadan önce bağlantı kurmalısınız.",
    "Do you want to connect to {mmUrl}?" : "{mmUrl} ile bağlantı kurulsun mu?",
    "You can choose another Mattermost server in the {settingsHtmlLink} section of your personal settings." : "Kişisel ayarlarınızın {settingsHtmlLink} bölümünden başka bir Mattermost sunucusu seçebilirsiniz.",
    "Connect" : "Bağlan",
