OC.L10N.register(
    ...
    "Mattermost admin options saved" : "Параметры администратора Mattermost сохранены",
    ...
    "Nothing" : "Ничего",
    "_{fileName} was sent to {channelName}_::_{count} files were sent to {channelName}_" : ["{fileName} был отправлен в {channelName}","{count} файлов было отправлено в {channelName}","{count} файлов было отправлено в {channelName}","{count} файлов было отправлено в {channelName}"],
